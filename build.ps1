...
& java -jar swagger-codegen-cli-2.4.14.jar generate -i https://api.cloudmersive.com/spam/v1/swagger.json -l go -c packageconfig.json
...
(Get-Content ./README.md).replace('This Python package is automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project:', 'This Go package provides a native API client for [Cloudmersive Spam Detection API](https://cloudmersive.com/spam-detection-api)') | Set-Content ./README.md
Write-Host "Done."